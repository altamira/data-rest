...
ALTER SEQUENCE "MEASUREMENT_SEQUENCE" RESTART WITH 1000;
ALTER SEQUENCE "PROCESS_SEQUENCE" RESTART WITH 1000;
ALTER SEQUENCE "PROPERTY_SEQUENCE" RESTART WITH 1000;
ALTER SEQUENCE "RELATION_SEQUENCE" RESTART WITH 1000;
ALTER SEQUENCE "RESOURCE_SEQUENCE" RESTART WITH 1000;
...
INSERT INTO MS_MAGNITUDE (ID,NAME) values ('4','tempo');
INSERT INTO MS_MAGNITUDE (ID,NAME) values ('3','unidade');
